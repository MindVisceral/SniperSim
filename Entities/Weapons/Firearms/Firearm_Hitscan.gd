...
@export var bullet_trail_emitter: PackedScene = \
	preload("res://Entities/Weapons/Effects/Base_Bullet_Trail_Emitter.tscn")

@export var shot_effect_emitter: PackedScene = \
	preload("res://Entities/Weapons/Effects/Base_Shot_Effect_Emitter.tscn")

@export var shot_fire_effect: PackedScene = \
	preload("res://Entities/Weapons/Effects/Base_Shot_Fire_Effect.tscn")
...
@export var hit_effect_emitter: PackedScene = \
	preload("res://Entities/Weapons/Effects/Base_Hit_Effect_Emitter.tscn")

## This Node creates a decal, we will instantiate it at the bullet end hit point.
@export var bullet_hole_decal: PackedScene = \
	preload("res://Entities/Weapons/Effects/Base_Bullet_Hole_Decal.tscn")
